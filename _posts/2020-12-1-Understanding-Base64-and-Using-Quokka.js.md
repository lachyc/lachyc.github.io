...
# Understanding Base64 and Using Quokka.js
...
First, append all 8-bit binary values onto one-another to create a single, long collection of zeroes and ones like so:
